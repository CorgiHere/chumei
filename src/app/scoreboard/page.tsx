...
export const metadata: Metadata = buildPageMetadata({
  ...
  description: `2026 竹梅賽（Chu Mei）總錦標：國立清華大學（清大／NTHU）${siteConfig.nthuScore}：${siteConfig.nycuScore} 國立交通大學／陽明交通大學（交大／NYCU／NCTU）。查看七場計分項目與完整賽果——恐龍賽跑、酒精微積分、辦公椅錦標賽、麻將、刷條碼競速、兩校憑拳。`,
  path: "/scoreboard",
});
